...
const Hero = () => {
    ...
    const hero_heading = "z-0 font-montserrat font-[900] uppercase tracking-[8px] text-dark_primary/80 resSm:text-[12vw] resMd:text-[16vw] resLg:text-[15vw] text-center pointer-events-none whitespace-nowrap";
  ...
  return (
    <div className={hero_container}>
      <motion.h1
        ...
        style={{ gridArea: "1 / 1" }} // TO STACK ART IMAGE AND TEXT WITHOUT USE OF ABSOLUTE POSITIONING
